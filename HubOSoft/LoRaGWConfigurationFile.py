...
# CONSTANTS
JSON_GW_CONFIGURATION_OBJ_NAME = "LoRa_GW_Configuration_File"
...
# Get the GW configuration file and create configuration file if doesn't exist
...
#Get all entry and prepare a dictionnary to create the json object 
def get_all_entry_and_create_JSON_GW_Conf_File():
    
    #Variables to receive the entries of interface 
    VersionGW = IHM.variable_VersionLoRaGWConfigFile_entry.get()
    ...
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME] = OrderedDict()
        
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME]["Version"] = VersionGW
                    
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_LAN] = OrderedDict()
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_LAN]["IPFixe"] = LanIPFixe
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_LAN]["IPAddr"] = LanIPAdrr
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_LAN]["IPMask"] = LanIPMask
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_LAN]["IPGw"] = LanIPGw
                
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN] = OrderedDict()
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN]["PIN"] = WwanPIN
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN]["PUK"] = WwanPUK
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN]["IPType"] = WwanIPType
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN]["APN"] = WwanAPN
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN]["APNUser"] = WwanAPNUser
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_WWAN]["APNPwd"] = WwanAPNPwd
                
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_TIME] = OrderedDict()
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_TIME]["SNTPServer"] = TimeSNTPServer
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_TIME]["TimeZone"] = TimeTimeZone
               
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE] = OrderedDict()
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["DNSServer"] = ServiceDNSServer
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSUrl"] = ServicePFSUrl
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSPort"] = ServicePFSPort
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSUser"] = ServicePFSUser
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSPwd"] = ServicePFSPwd
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSDataDirectory"] = ServicePFSDataDirectory
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSConfigDirectory"] = ServicePFSConfigDirectory
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSLinkFileName"] = ServicePFSLinkFileName
        
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSProvisionningFileName"] = ServicePFSProvisionningFileName
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSDataFilePeriodMinutes"] = ServicePFSDataFilePeriodMinutes
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["PFSLinkFilePeriodMinutes"] = ServicePFSLinkFilePeriodMinutes
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["EndDeviceSilenceTimeOutHours"] = ServiceEndDeviceSilenceTimeOutHours
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["FTPSUrl"] = ServiceFTPSUrl
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["FTPSPort"] = ServiceFTPSPort
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["FTPSUser"] = ServiceFTPSUser 
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_SERVICE]["FTPSPwd"] = ServiceFTPSPwd
                
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_DEBUG] = OrderedDict()
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_DEBUG]["SSHServer"] = DebugSSHServer
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_DEBUG]["SSHPort"] = DebugSSHPort
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_DEBUG]["LogLevel"] = DebugLogLevel
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_DEBUG]["WatchDog"] = DebugWatchDog
    new_json_object[JSON_GW_CONFIGURATION_OBJ_NAME][JSON_GW_CONF_TAB_NAME_DEBUG]["LogUpload"] = DebugLogUpLoad
    
    return new_json_object

# Create and return the incrementing name of the new configuration file 
